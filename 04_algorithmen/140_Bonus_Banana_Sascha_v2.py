...
# Weg 2
a = int(input('Gib ein wie viele Bananen ganz zum Schluss nach der letzten Teilung\n jeder Pirat erhalten hat\n Zum Beispiel 1.\n'))
for i in range(1,5):
    a = 3*a+1
print(f'Die Helden haben {a} Bananen am Vortag gesammelt.')