...
print('y = 3 * w + 1')            # Tom
print('w = 3 * v + 1')            # Steve
print('v = 3 * t + 1')            # letzte Teilung
t = 1

print('nach x die Gleichungen umschreiben durch Substitution')
print('w = (3 * ( 3 * t + 1) + 1)')
print('y = (3 * (3 * (3 * t + 1) + 1) + 1)')
print('x = 3 * (3 * (3 * (3 * t + 1) + 1) + 1) + 1')
w = (3 * ( 3 * t + 1) + 1)
y = (3 * (3 * (3 * t + 1) + 1) + 1)
x = 3 * (3 * (3 * (3 * t + 1) + 1) + 1) + 1

print(f'Ergebnis: Die drei Helden haben mindestens {x} Bananen gesammelt.')

# Weg 2
a = int(input('Gib ein wie viele Bananen ganz zum Schluss nach der letzten Teilung jeder Pirat erhalten hat?\n'))
for i in range(1,5):
    a = 3*a+1
print(a)